...
namespace SisEUs.Application.Apresentacoes
{
        ...
        ILoggedUser loggedUser) : IApresentacaoServico
    {
        ...
        public async Task<Resultado<IEnumerable<ApresentacaoResposta>>> ObterApresentacoesPorAutorAsync(CancellationToken cancellationToken)
        {
            logger.LogInformation("Obtendo apresentações do autor logado");
